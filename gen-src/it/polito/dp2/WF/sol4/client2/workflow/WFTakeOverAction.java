...
public interface WFTakeOverAction {
    ...
    @RequestWrapper(localName = "takeOverAction", targetNamespace = "http://www.example.org/Workflow/", className = "it.polito.dp2.WF.sol4.client2.workflow.TakeOverAction")
    @ResponseWrapper(localName = "takeOverActionResponse", targetNamespace = "http://www.example.org/Workflow/", className = "it.polito.dp2.WF.sol4.client2.workflow.TakeOverActionResponse")
