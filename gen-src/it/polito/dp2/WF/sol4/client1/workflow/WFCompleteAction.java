...
public interface WFCompleteAction {
    ...
    @RequestWrapper(localName = "completeAction", targetNamespace = "http://www.example.org/Workflow/", className = "it.polito.dp2.WF.sol4.client1.workflow.CompleteAction")
    @ResponseWrapper(localName = "completeActionResponse", targetNamespace = "http://www.example.org/Workflow/", className = "it.polito.dp2.WF.sol4.client1.workflow.CompleteActionResponse")
    ...
    @RequestWrapper(localName = "checkSimpleOrProcess", targetNamespace = "http://www.example.org/Workflow/", className = "it.polito.dp2.WF.sol4.client1.workflow.CheckSimpleOrProcess")
    @ResponseWrapper(localName = "checkSimpleOrProcessResponse", targetNamespace = "http://www.example.org/Workflow/", className = "it.polito.dp2.WF.sol4.client1.workflow.CheckSimpleOrProcessResponse")
