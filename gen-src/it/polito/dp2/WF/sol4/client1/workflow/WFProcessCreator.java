...
public interface WFProcessCreator {
    ...
    @RequestWrapper(localName = "createProcess", targetNamespace = "http://www.example.org/Workflow/", className = "it.polito.dp2.WF.sol4.client1.workflow.CreateProcess")
    @ResponseWrapper(localName = "createProcessResponse", targetNamespace = "http://www.example.org/Workflow/", className = "it.polito.dp2.WF.sol4.client1.workflow.CreateProcessResponse")
