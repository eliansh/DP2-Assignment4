...
public interface WFTakeOverAction {
    ...
    @RequestWrapper(localName = "takeOverAction", targetNamespace = "http://www.example.org/Workflow/", className = "it.polito.dp2.WF.sol4.client1.workflow.TakeOverAction")
    @ResponseWrapper(localName = "takeOverActionResponse", targetNamespace = "http://www.example.org/Workflow/", className = "it.polito.dp2.WF.sol4.client1.workflow.TakeOverActionResponse")
